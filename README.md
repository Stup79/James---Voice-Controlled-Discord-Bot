...
1. The bot and all its components. Note that Discord does not allow for bots to actually listen to conversations. Instead James hears what you can hear, as explained below in Prerequisites.
